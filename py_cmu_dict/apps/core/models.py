...
class Dictionary(StandardModelMixin):
    ...
    ipa_phonetic = models.CharField(max_length=100, null=True, blank=True, verbose_name="Phonetic transcription")
    ipa_phonetic_syllables = models.CharField(max_length=100, null=True, blank=True)
