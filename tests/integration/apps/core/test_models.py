...
def test_should_create_dictionaries():
    ...
    d_1 = create_dictionary(word_1, language, phonemic=phonemic_1)
    assert d_1.word_or_symbol == word_1
    assert d_1.phonemic == phonemic_1
    assert d_1.language.name == language.name
    create_dictionary(word_2, language, phonemic=phonemic_1)
    create_dictionary(word_3, language, phonemic=phonemic_1)
    create_dictionary(word_4, language, phonemic=phonemic_2)
    create_dictionary(word_5, language, phonemic=phonemic_3)
